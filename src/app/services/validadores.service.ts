...
export class ValidadoresService {
  ...
  existeUsuario( control: FormControl ): Promise<ErrorValidate> {
    ...
    return new Promise( (resolve, reject) => {
      ...
      setTimeout(() => {
        if ( control.value.toLowerCase() === 'crisamw' ) {
  ...
  passwordsIguales( pass1Name: string, pass2Name: string): (formulario: FormGroup) => void {
